...
q = torch.randn(5, 3, 32, device='cuda', dtype=torch.float16, requires_grad=True)  # total_q = 5
k = torch.randn(5, 2, 32, device='cuda', dtype=torch.float16)
v = torch.randn(5, 2, 32, device='cuda', dtype=torch.float16)
...
print("Softmax logsumexp:", output[1])  # optional
