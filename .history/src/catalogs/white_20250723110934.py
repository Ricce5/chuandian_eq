...
from src.data import Catalog, InMemoryDataset, Sequence, default_catalogs_dir

from .catalog_utils import train_val_test_split_sequence
...
class White(Catalog):
    ...
    def generate_catalog(self):
        ...
        # 保存处理后的 DataFrame 为 CSV
        subset_df.to_csv(self.root_dir / "catalog.csv")
