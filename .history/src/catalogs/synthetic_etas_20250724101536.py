...
from eq.data import Catalog, TppDataset, default_catalogs_dir
...
class ETAS_MultiCatalog(Catalog):
    ...
    def generate_catalog(self):
        ...
        d_train = TppDataset(sequences=sequences[:num_train])
        d_val = TppDataset(sequences=sequences[num_train : num_train + num_val])
        d_test = TppDataset(sequences=sequences[num_train + num_val :])
...
class ETAS_SingleCatalog(Catalog):
    ...
    def generate_catalog(self):
        ...
        dataset = TppDataset(sequences=sequences)
        dataset.save_to_disk(self.root_dir / "full_sequence.pt")


class ToyETAS:
    def __init__(self):
        dset = TppDataset.load_from_disk(default_catalogs_dir / "etas_kelian.pt")
        self.train = dset
        self.val = dset
        self.test = dset
        self.metadata = {
