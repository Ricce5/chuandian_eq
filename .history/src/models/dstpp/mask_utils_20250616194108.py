...
def get_attn_mask(seq,pad=PAD):
    attn_mask_subseq = get_subsequent_mask(seq,pad)
    attn_mask_keypad = get_attn_key_pad_mask(seq,seq)
    attn_mask_keypad = attn_mask_keypad.type_as(attn_mask_subseq)
    attn_mask = (attn_mask_keypad + attn_mask_subseq).gt(0)
    return attn_mask
