...
@BaseEncoder.register("Encoder_Logdeltat")
class Encoder_Logdeltat(BaseEncoder):
    """A reusable encoder for event locations with time-aware attention."""
    ...
    caches: Optional[List[Dict[str, torch.Tensor]]] = None
        ...
        output = torch.cat([outputs["default"], log_inter_time], dim=-1)
        return output
