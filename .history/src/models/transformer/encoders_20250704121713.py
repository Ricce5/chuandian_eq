...
from src.utils.mask_utils import get_subsequent_mask, get_attn_key_pad_mask, get_non_pad_mask
...
@BaseEncoder.register("Encoder_TM")
class Encoder(BaseEncoder):
    ...
    def forward(self, event_loc, event_time, non_pad_mask):
        ...
        enc_output = self.mag_emb(event_loc) * non_pad_mask
        enc_output += tem_enc  
