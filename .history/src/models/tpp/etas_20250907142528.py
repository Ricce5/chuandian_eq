...
import src
from src.data.batch import get_mask, pad_sequence
...
class ETAS(TPPModel):
    ...
    def sample_thinning(
        ...
        Args:
            ...
            return_sequences: if true, returns samples as list[src.data.sequence].
                if false, returns samples as src.data.batch.
        """
        p, c, mu, k, alpha = [
        ...
        while len(sequences) < batch_size:
            ...
            filtered = [
                src.data.Sequence(**seq) for seq in new_sequences if seq is not None
            ]
