...
class Mamba2Rotary(nn.Module, PyTorchModelHubMixin):
    def __init__(
        self,
        d_model,
        d_state=128,
        ...
        self.rotary_emb_dim = d_state//2
        if self.rotary_emb_dim > 0:
            assert RotaryEmbeddingTime is not None, "rotary requires flash_attn to be installed"
            self.rotary_emb = RotaryEmbeddingTime(
                self.rotary_emb_dim,
