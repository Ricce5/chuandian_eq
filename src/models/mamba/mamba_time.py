# Modified Mamba1 to directly take inter-event times as input, similar to https://arxiv.org/abs/2407.05302
# ref: https://github.com/state-spaces/mamba/blob/main/mamba_ssm/modules/mamba_simple.py
