...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, choices=['Classifier'], required=True, help='Model name')
    ...
    if args_cli.mode == "train":
        ...
        checkpoint_path = f"{args.save_dir}/best_model_{args_cli.trial_index}.pth"
